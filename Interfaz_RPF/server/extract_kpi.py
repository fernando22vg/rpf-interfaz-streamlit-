...
METRIC_MAP = [
    ('P_max [MW]',          'p_max_mw',       'float'),
    ('P_0 [MW]',            'p_0_mw',         'float'),
    ('P_35 [MW]',           'p_35_mw',        'float'),
    ...
    ('Aporta a la RPF',     'aporta_rpf',     'str'),
    ('droop informado [%]', 'droop_inf_pct',  'float'),
    ('droop calculado [%]', 'droop_calc_pct', 'float'),
    ('f_0 [Hz]',            'f_0_hz',         'float'),
    ('f_min [Hz]',          'f_min_hz',       'float'),
    ('f_35 [Hz]',           'f_35_hz',        'float'),
    ('t_0',                 't_0',            'time'),
    ('t_min',               't_min',          'time'),
    ('t_35',                't_35',           'time'),
