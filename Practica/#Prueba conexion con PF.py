...
project=app.ActivateProject("Pruebas")
...
for i in line:
    name = i.GetAttribute('loc_name')  # Get name of the current line
    loading = i.GetAttribute('c:loading')  # Get loading value of the current line
